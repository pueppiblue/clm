 ...
 */
class Version20160503195138 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, looter_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, drop_date DATETIME NOT NULL, type VARCHAR(255) NOT NULL, isCash TINYINT(1) NOT NULL, INDEX IDX_1F1B251EB13C2BDA (looter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
